"""
The face detector used is SFD (taken from face-alignment)
...
from libs.sfd.sfd_detector import SFDDetector as FaceDetector
from libs.fan_model.models import FAN, ResNetDepth
from libs.fan_model.utils import *
	...
	def get_landmarks(self, face, image):
		...
		if self.landmarks_type == LandmarksType._3D:
			...
			depth_pred = self.depth_prediciton_net(
				torch.cat((inp, heatmaps), 1)).view(68, 1)
